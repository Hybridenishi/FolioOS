...
Updating: read FolioOS's CHANGELOG between this release and the target, adopt deliberately, bump this file, recompile the adapter artifacts, and commit both together.
